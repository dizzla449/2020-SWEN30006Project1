...
public class MailItem {
    ...
    public enum MailType { REGULAR, FOOD }
    protected final MailType mail_type;
     ...
     */
    public MailItem(int dest_floor, int arrival_time, int weight, MailType mail_type){
    ...
    public String toString(){
    	...
    	switch(this.mail_type) {
    		case REGULAR:
    	        string = String.format("Mail Item:: ID: %6s | Arrival: %4d | Destination: %2d | Weight: %4d", id, arrival_time, destination_floor, weight);
    	        break;
    		case FOOD:
    	        string = String.format("Food Item:: ID: %6s | Arrival: %4d | Destination: %2d | Weight: %4d", id, arrival_time, destination_floor, weight);
    	        break;
    	}
        return string;
    }
